...
public class WednesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.homemade.akhilez.timetable.Table.dayString="Wed";
        ...
        if (Table.dayString.equals(Table.getDay())){
            ...
            headingText.setTextColor(Color.parseColor(Table.colors[2]));
        ...
        if(Table.getDay().equals(Table.fragmentDay)){
            if(curPeriodInt>=0 && curPeriodInt<=8) {
                ViewPagerContents.highlight(relative[curPeriodInt],periods[curPeriodInt],times[curPeriodInt],Table.colors[2]);
