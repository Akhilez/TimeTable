...
public class ThursdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.homemade.akhilez.timetable.Table.dayString="Thu";
        ...
        if(Table.getDay().equals(Table.fragmentDay)){
            if(curPeriodInt>=0 && curPeriodInt<=8) {
                ViewPagerContents.highlight(relative[curPeriodInt],periods[curPeriodInt],times[curPeriodInt],Table.colors[3]);
